      ...
      <div className="max-w-5xl mx-auto text-left">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <h1 className={`text-3xl font-semibold font-poppins mt-2 ${
        ...
        <div className="relative mt-10 text-left" ref={timelineRef}>
          {/* background line */}
          <div
            className={`absolute top-6 bottom-6 left-[1.5rem] w-0.5 ${
            ...
            {steps.map((step, idx) => (
              ...
              >
                ...
                <div className="w-12 flex justify-center relative">
                  <div
                    className={`relative z-10 w-12 h-12 rounded-full flex items-center justify-center border-4 transition-colors duration-500 shadow ${
                      idx <= activeStep
