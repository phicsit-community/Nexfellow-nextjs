  ...
  return (
    <>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.mainContainer}>
          ...
          <div className={styles.content}>
            ...
            <section id="introduction" className={styles.section}>
              ...
              <div className={styles.sectionContent}>
                ...
                <p>
                  ...
                  so we can try to find a solution. These policies apply to all
            ...
            <section id="retention" className={styles.section}>
              ...
              <div className={styles.sectionContent}>
                <p>
                  NexFellow retains your personal information only for as long
                  as necessary to fulfill the purposes for which it was
                  collected, including providing our services, complying with
                  legal obligations, resolving disputes, and enforcing our
                  agreements. The retention period may vary depending on the
                  type of data and applicable legal requirements. Inactive
                  accounts and associated data may be deleted after a reasonable
                  period of inactivity, in accordance with our internal
                  policies.
                </p>
              </div>
            </section>
            ...
            <section id="cookies" className={styles.section}>
              ...
              <div className={styles.sectionContent}>
                <p>
                  NexFellow uses cookies and similar tracking technologies to
                  enhance your browsing experience, analyze platform usage,
                  remember your preferences, and deliver personalized content.
                  These technologies help us understand how users interact with
                  our platform, enabling us to improve functionality and
                  performance. You can control or disable cookies through your
                  browser settings; however, doing so may affect certain
                  features or functionalities of the platform. By continuing to
                  use NexFellow, you consent to our use of cookies and tracking
            ...
            <section id="transfers" className={styles.section}>
              ...
              <div className={styles.sectionContent}>
                <p>
                  NexFellow may transfer, store, and process your information
                  outside of your country of residence, including in countries
                  where data protection laws may differ. We ensure appropriate
                  safeguards, such as standard contractual clauses, are in place
                  for such transfers to comply with applicable laws.
                </p>
              </div>
            </section>
            ...
            <section id="third-party" className={styles.section}>
              ...
              <div className={styles.sectionContent}>
                <p>
                  ...
                  the content of such third-party services. We encourage users
                  to read the privacy policies of any third-party sites they
                  visit.
                </p>
              </div>
            </section>
              ...
              <div className={styles.sectionContent}>
                ...
                <div className={styles.listContainer}>
                  ...
                  <div className={styles.listItem}>
                    <img src={tick?.src || tick} alt="tick" />
                    <div>
                      Sending a notification via email or platform notice (if
                      appropriate)
                    </div>
                  </div>
                  <div className={styles.listItem}>
                    <img src={tick?.src || tick} alt="tick" />
                    <div>
                      The updated policy will take effect on the date indicated
        ...
        >
          {/* Use Lucide React's Button component for accessibility and style */}
          <span
            style={{
              display: "flex",
              alignItems: "center",
